...
export default function Footer() {
    return (
        <footer className="relative border-t border-neon-red/20 bg-black" data-testid="site-footer">
            ...
            <div className="border-t border-white/10 text-center py-4 text-xs text-white/40 font-display tracking-wider uppercase">
                © {new Date().getFullYear()} GAMEBREW · Brewed for Gamers
            </div>
        </footer>
    );
}
